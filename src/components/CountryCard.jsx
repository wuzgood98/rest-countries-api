...
const CountryCard = ({ population, region, capital, name, flag }) => (
  <Link to={`/country-details/${name}`} className="w-[271px] flex-grow h-max cursor-pointer drop-shadow-md translate-y-0 hover:drop-shadow-xl hover:-translate-y-1 transition-all">
